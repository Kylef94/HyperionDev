...
1. Add another method in the Course class that prints the head office location: Cape Town X


2. Create a subclass of the Course class named OOPCourse X

3. Create a constructor that initialises the following attributes and assigns these values: X
...
4. Create a method in the subclass named "trainer_details" that prints what the 
   course is about and the name of the trainer by using the description and trainer attributes. X
...
class OOPCourse(Course):
    ...
    def trainer_details(self):
        print(f"This course is about {self.description}, it is taught by {self.trainer}")
